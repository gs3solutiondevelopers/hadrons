    ...
    <div className="home-page">
      ...
      <section className="hero-section" id="home">
        ...
        <div className="container hero-container">
          ...
          {/* =====================================================================
               2. Bottom Product Grid Showcase (11 Cards in 2 Rows — Exact Mockup)
               ===================================================================== */}
      ...
      {/* =========================================================================
           3. Comprehensive Product Ecosystem Section (4 Flagship Cards)
           ========================================================================= */}
      <section className="products-section" id="products">
        <div className="container">
          <div className="section-header-center">
            <div className="section-tag"><Grid size={16} /> Product Ecosystem</div>
            <h2 className="section-heading">COMPLETE <span>PRODUCT ECOSYSTEM</span></h2>
            <p className="section-sub">Engineered to perfection with 99.99% high-purity electrolytic copper, fire-retardant FRLS polymers, and high-efficiency power electronics.</p>
          </div>
          ...
          <div className="product-grid" id="productGrid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(260px, 1fr))', gap: '24px' }}>
            ...
            <div className="product-card">
              ...
              <div className="product-body">
                <div className="product-icon-wrap">
                  <Zap className="product-icon" size={16} />
            ...
            <div className="product-card">
              ...
              <div className="product-body">
                <div className="product-icon-wrap">
                  <ToggleRight className="product-icon" size={16} />
                  <span>ARCHITECTURAL SWITCHES</span>
                </div>
            ...
            <div className="product-card">
              ...
              <div className="product-body">
                <div className="product-icon-wrap">
                  <Server className="product-icon" size={16} />
                  <span>DATA CENTER &amp; CORDS</span>
                </div>
            ...
            <div className="product-card">
              ...
              <div className="product-body">
                <div className="product-icon-wrap">
                  <BatteryCharging className="product-icon" size={16} />
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '16px', marginTop: '45px', flexWrap: 'wrap' }}>
            <Link to="/products" className="btn btn-primary btn-lg" style={{ padding: '16px 36px', fontSize: '1.02rem' }}>
              <span>EXPLORE ALL 11+ PRODUCTS &amp; TECHNICAL SPECS</span>
              <ArrowRight size={18} />
            </Link>
            <Link to="/oem" className="btn btn-secondary" style={{ padding: '16px 28px' }}>
      ...
      {/* =========================================================================
           4. About Us & Manufacturing Standards Section
           ========================================================================= */}
